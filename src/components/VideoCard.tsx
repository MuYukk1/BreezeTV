...
const VideoCard = forwardRef<VideoCardHandle, VideoCardProps>(
  function VideoCard(
    ...
    useEffect(() => {
      // 即将上映的内容需要检查收藏状态
      const shouldCheckFavorite =
        isUpcoming || (from !== 'douban' && from !== 'search');
    ...
    const handleToggleFavorite = useCallback(
      async (e: React.MouseEvent) => {
        ...
        // 即将上映的内容允许收藏
        if ((from === 'douban' && !isUpcoming) || !actualSource || !actualId)
          return;
          ...
          >
            ...
            {hasReleaseTag &&
              (() => {
                ...
                let emoji = '🔜';
                let bgColors =
                  'from-orange-500/95 via-red-500/95 to-pink-600/95';
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {/* 背景渐变效果 */}
                      <span
                        className={`absolute inset-0 bg-gradient-to-r from-transparent via-green-50/0 to-transparent dark:via-green-500/0 transition-all duration-300 ${bgGradient}`}
                      ></span>
